...
from orders.views_public import last_order
...
api_patterns = [
    ...
    # Stripe
    path("api/checkout/stripe-session/", stripe_views.create_stripe_session),
    path("api/stripe/webhook/", stripe_views.stripe_webhook),
